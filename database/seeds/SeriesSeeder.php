            ...
            array(                      //product type Array    //laptops
                ...
                array(                  //Brand array       //ASUS
                    ...
                    array(              //Series Array      //series_id = 6
                      "name" => "VivoBook",
                      "details" => "The Asus VivoBook is eye-catching design is backed by good performance and solid battery life. Sleek design; Gorgeous color options; Good performance; Runs cool; Affordable. The Asus VivoBook S15 S530UA ($699) proves that innovation isnt limited to premium laptops. This excellent mainstream system is truly one of a kind. Inspired by the laptop maker pricier ZenBook S, the VivoBook S15 features Asus new ErgoLift hinge, which angles the keyboard for a more comfortable typing experience. As if that were not unique enough, the VivoBook is available in several striking color schemes, including a gorgeous turquoise green and a blinding yellow",
                      "brand_id" => 2,
                    ),
                ...
                array(                  //Brand array       //LENOVO
                    array(              //Series Array      //series_id = 12
                      "name" => "ThinkPad",
                      "details" => "The Maserati of business laptops, Lenovos thinkpad X Carbon packs plenty of performance and battery life into a slim and sexy carbon-fiber chassis. Starting at $1,063,the 6th-Generation X1 Carbon retains the fantastic keyboard and colorful display of its predecessor but dramatically improves on the previous models performance by going from an Intel 7th Gen dual-core processor to an 8th Gen, quad-core CPU. Thats like moving from a four-cylinder to an eight-cylinder engine. Throw in some new design elements, an eye-popping HDR screen and far-field microphones, and this luxurious laptop is the best productivity system money can buy",
                      "brand_id" => 4,
                    ),
                    ...
                    array(              //Series Array      //series_id = 14
                      "name" => "Legion",
                      "details" => "Stylishly Savage. You work hard during the day and tend to other obligations at night - but theres still a warrior inside you. Lenovo legion delivers gaming PCs that give that warrior the power to compete, with style thats impressive in any environment",
                      "brand_id" => 4,
                    ),
