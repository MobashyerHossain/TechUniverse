            ...
            array(            //Brand array     //HP
                array(        //Series array    //Pavilion
                    array(    //Product array   //product_id = 1
                        "name" => "HP Pavilion 15-cs0207ng 4FQ98EA 39.6 cm (15.6 inch) Notebook (silver)",
                        "buying_price" => 799.99,
                        "series_id" => 1,
                    ),

                    array(    //Product array   //product_id = 2
                        "name" => "HP Pavilion 17-ab440ng 4PQ44EA 43.9 cm (17.3 inch) Notebook (black)",
                        "buying_price" => 849.99,
                        "series_id" => 1,
                    ),

                    array(    //Product array   //product_id = 3
                        "name" => "HP Pavilion 15-cx0402ng 39.6 cm (15.6 inch) Notebook (black)",
                        "buying_price" => 799.49,
                        "series_id" => 1,
                    ),
                ),

                array(        //Series array    //Spectre
