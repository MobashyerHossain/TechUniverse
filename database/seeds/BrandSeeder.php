        ...
        $brands = array(
            array(                //laptop brand array
                ...
                array(					                   //brand_id = 4
                  "name" => "LENOVO",
                  "category_id" => 1,
                  "details" => "Lenovo Group Ltd. or Lenovo PC International, often shortened to Lenovo, is a Chinese multinational technology company with headquarters in Beijing, China, and Morrisville, North Carolina, United States. It designs, develops, manufactures, and sells personal computers, tablet computers, smartphones, workstations, servers, electronic storage devices, IT management software, and smart televisions. Lenovo was the worlds largest personal computer vendor by unit sales from 2013 to 2015. It markets the ThinkPad line of notebook computers, IdeaPad, Yoga and Legion lines of notebook laptops, and the IdeaCentre and ThinkCentre lines of desktops",
                ),
            ...
            array(                //smart phone brand array
                ...
                array(					                   //brand_id = 10
                  "name" => "VIVO",
                  "category_id" => 2,
                  "details" => "Vivo Communication Technology Co. Ltd. is a Chinese technology company owned by BBK Electronics that makes smartphones, smartphone accessories, software, and online services. It was founded in 2009 in Dongguan, China. The company develops software for their phones such as the Vivo App Store, iManager included in their proprietary Android-based operating system called Funtouch OS. Vivo joined the ranks of the top 10 smartphone makers in the first quarter of 2015 with a global market share of 2.7%. With research and development centers in Shenzhen and Nanjing, the company employs 1,600 R&D personnel as of January 2016. Since the companys founding in 2009, Vivo has expanded to over 100 countries around the world. Vivo began its international expansion in 2014 when it entered the Thai market. The company quickly followed up with launches in the India, Indonesia, Malaysia, Myanmar, the Philippines, Thailand, and Vietnam",
                ),

                array(					                   //brand_id = 11
                  "name" => "ONE PLUS",
                  "category_id" => 2,
                  "details" => "OnePlus is a Shenzhen-based Chinese smartphone manufacturer founded by Pete Lau (CEO) and Carl Pei in December 2013. The company officially serves 34 countries and regions around the world as of July 2018. They have released numerous phones, amongst other products. OnePlus was founded on 16 December 2013 by former Oppo vice-president Pete Lau and Carl Pei. According to the Chinese governments documentation, the only institutional stockholder in OnePlus is Oppo Electronics. Lau denied that OnePlus was a wholly-owned subsidiary of Oppo and stated that Oppo Electronics and not Oppo Mobile (the phone manufacturer) is a major investor of OnePlus and that they are in talks with other investors. The companys main goal was to design a smartphone that would balance high-end quality with a lower price than other phones in its class, believing that users would Never Settle for the lower-quality devices produced by other companies",
                ),

                array(					                   //brand_id = 12
                  "name" => "XIAOMI",
                  "category_id" => 2,
                  "details" => "Xiaomi Corporation is a Chinese electronics company headquartered in Beijing. Xiaomi makes and invests in smartphones, mobile apps, laptops, and related consumer electronics. Xiaomi released its first smartphone in August 2011 and rapidly gained market share in China to become the countrys largest smartphone company in 2014. At the start of Q2 of 2018, Xiaomi was the worlds fourth-largest smartphone manufacturer, leading in both the largest market, China, and the second-largest market, India. Xiaomi has 15,000 employees in China, India, Malaysia, Singapore and is expanding to other countries including Indonesia, the Philippines, and South Africa. According to Forbes magazine, Lei Jun, the founder and CEO, has an estimated net worth of US$12.5 billion. He is Chinas 11th richest person and 118th in the world. Xiaomi is the worlds 4th most valuable technology start-up after receiving US$1.1 billion funding from investors, making Xiaomis valuation more than US$46 billion",
                ),
            ),
        );
