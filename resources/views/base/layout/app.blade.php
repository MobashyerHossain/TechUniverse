...
<head>
    ...
    <!-- Scripts -->
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.0/jquery.min.js"></script> <!--get local file and add those -->
    ...
    <link rel="stylesheet" href="{{ asset('FrontEnd/Consumers/assets/js/jquery.min.js') }}">
