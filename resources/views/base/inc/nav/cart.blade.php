...
<div class="hover-dropdown col p-0" style="background-color:rgba(179,179,179,0.22);cursor:pointer;">
  <div class="dropbtn no-outline p-0">
    <i class="fa fa-shopping-cart float-left mr-3 ml-0" style="cursor:pointer;font-size:30px;color:rgb(162,171,180);padding:5px;"></i>
    @guest
  ...
  <!--Cart dropdown-->
  <div class="hover-dropdown-content border p-0" style="right:0px;top:60px;width:350px;">
    @guest
