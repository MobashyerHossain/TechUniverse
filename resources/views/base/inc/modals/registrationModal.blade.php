      ...
      <div class="modal-body">
        ...
        <form method="POST" action="{{ route('consumer.register.submit') }}" aria-label="{{ __('Register') }}">
            ...
            <div class="form-group row">
                <!--password-->
                <div class="col-12 col-md-6">
                    <input id="password" type="password" minlength="6" maxlength="20" class="rounded-0 no-outline form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" name="password" placeholder="Password">
                ...
                <!--confirm password-->
                <div class="col-12 col-md-6">
                    <input id="password-confirm" type="password" minlength="6" class="rounded-0 no-outline form-control" name="password_confirmation" placeholder="Confirm Password" required>
                </div>
            </div>
